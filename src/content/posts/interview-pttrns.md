...
tags:
  ...
  - German
  - PTTRNS
coverImage: http://berlinbeat.org/wp-content/uploads/2013/05/pttrns01.jpg?w=300
gallery: []
draft: false
---

PTTRNS - Photo courtesy of PTTRNS

If you want to be specific, [PTTRNS](https://www.facebook.com/PTTRNS) is a Cologne-based quartet playing experimental indie music and consisting of Benjamin Riedl, Hendrik Frese, Patrick Hohlweck, and Daniel Mertens. But if you want to be correct, PTTRNS is everyone and everything that it comes across, inspires, or is inspired by.
...
To date, PTTRNS has already released 2010's debut, _Science Piñata_, and 2012's two-part 12" series, _Love Quest_, along with a series of 7" releases, on [Altin Village & Mine](http://www.altinvillage.de/). The band has worked with the label since 2007, but describes the relationship as atypical, motivated by the love of music as opposed to being a purely business-based interaction.

"We just love the way they handle things, and it's a very wonderful relationship," Mertens shared.

And just last month, PTTRNS released its second full-length, _Body Pressure_, also with the label. But for this album, the process was not like in the past.
...
As a result, he said that there wasn't as much cohesion between songs on that album. Whereas with _Body Pressure_, the group wrote with intention, and made sure that the outcome matched up to what discussions leading up to writing and recording dictated. Additionally, it helped that the writing process was conducted over a shorter period of time, leading to more condensed discussions, thoughts, and influences, which were then revisited when it came time to record.
...
Along with the album, PTTRNS released a music video for the song _Strong Talk_, something the members were initially a bit reluctant to do.
...
\[vimeo http://www.vimeo.com/62003781 w=500&h=281\]
...
_PTTRNS play tonight at [KuZe](http://www.kuze-potsdam.de/) in Potsdam. The show begins at 20.00._
